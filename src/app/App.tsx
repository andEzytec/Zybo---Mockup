...
export default function App() {
  ...
  async function startRegistro() {
    ...
    await typeMessage('bot',
      `Hola 👋\nSoy Zybo, tu asistente de movilidad y pago de parqueadero.\n\n Regístrate para disfrutar tu experiencia de estacionamiento sin filas, sin demoras, sin estrés y con beneficios exclusivos, en los principales centros comerciales del país.`,
      1200
    );
    setTimeout(() => {
